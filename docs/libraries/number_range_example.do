...
function Main(_)
	...
	let range_2 = Range([1, 5, 0.2])
	Show("\n")
	ShowRange(range_2)

	let range_3 = Range([1, 1, 0.2])
	Show("\n")
	ShowRange(range_3)

	let range_4 = Range([5, 1, 0.2])
	Show("\n")
	ShowRange(range_4)

	let range_5 = Range([1, 5, 0.7, TRUE])
	Show("\n")
	ShowRange(range_5)

	let range_6 = Range([1, 1, 0.7, TRUE])
	Show("\n")
	ShowRange(range_6)

	let range_7 = Range([5, 1, 0.7, TRUE])
	Show("\n")
	ShowRange(range_7)
end
